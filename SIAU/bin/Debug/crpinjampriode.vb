...
Public Class crpinjampriode
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Sistem_informasi_alat_ukur_PT.UTC.crpinjampriode.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_validasi() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class Cachedcrpinjampriode
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crpinjampriode = New crpinjampriode()
        rpt.Site = Me.Site
        Return rpt
    End Function
